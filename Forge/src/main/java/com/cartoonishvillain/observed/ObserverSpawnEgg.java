...
public class ObserverSpawnEgg extends SpawnEggItem {
    ...
    public ObserverSpawnEgg(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColorIn, final int secondaryColorIn, final Properties properties) {
